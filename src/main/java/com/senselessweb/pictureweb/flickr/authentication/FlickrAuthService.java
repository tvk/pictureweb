...
public class FlickrAuthService implements FlickrProvider {
	...
	public FlickrAuthService(final ApplicationEventPublisher publisher, final Context context) throws MalformedURLException {
	...
	private void generateCallbackUrl() throws MalformedURLException {
		requestToken = authInterface.getRequestToken(
				new URL(baseUrl, FlickrAuthCallbackController.FLICKR_CALLBACK_URL_REQUEST_MAPPING).toString());
